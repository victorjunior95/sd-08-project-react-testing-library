...
describe('Teste `<Pokédex />` componente', () => {
  it('deve rederizar h2 `Encountered pokémons`.', () => {
  ...
  it('Rederizar prox pokemon `Próximo botão`', () => {
  ...
  it('Rederizar botões dinamicamente', () => {
    const { getAllByTestId } = renderPokedexWithRouter();
  ...
  it('Tirar botão caso haja um unico pokemon', () => {
    const { getByRole } = renderPokedexWithRouter();
