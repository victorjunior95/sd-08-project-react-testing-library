...
test('test if a pokemon card is rendered', () => {
...
test('test if the card has a link to show the pokemons details', () => {
...
test('test if clicking on the details link redirects Pokémon details page.', () => {
