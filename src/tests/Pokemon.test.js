...
describe('Teste o componente <Pokemon.js />', () => {
  it('Teste se é renderizado um card com o nome correto do Pokemon', () => {
  ...
  it('Teste se é renderizado um card com o tipo correto do Pokemon', () => {
    const { getByTestId } = render(
      <MemoryRouter>
        <App />
      </MemoryRouter>,
  ...
  it('Teste se é exibida a imagem do pokemon', () => {
  ...
  it('Verifica se existe o id do Pokémon ao clicar em More details', () => {
