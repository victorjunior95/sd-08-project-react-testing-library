...
describe('Pokemon.js', () => {
  it('verifies if it shows all the infos about selected pokemon', () => {
  ...
  it('verifies if it has a link that redirects to a page with details', () => {
  ...
  it('verifies the favorite icon when pokemon is favorite', () => {
