...
test('Verifica se a página contém 2 parágrafos', () => {
  ...
  const paragrafoUm = getByText('This application simulates a Pokédex, a digital encyclopedia containing all Pokémons');
  
  const paragrafoDois = getByText('One can filter Pokémons by type, and see more details for each one of them')
