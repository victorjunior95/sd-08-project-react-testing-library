...
const About = () => (
  <section>
    <h2>{`About ` + `Pokédex`}</h2>
    <section>
      <p data-testid="paragraph-about">
        This application simulates a Pokédex, a
        digital encyclopedia containing all Pokémons
      </p>
      <p data-testid="paragraph-about">One can filter Pokémons by type, and see more details for each one of them</p>
      <img
        className="pokedex-image"
        data-testid="image-pokedex-about"
